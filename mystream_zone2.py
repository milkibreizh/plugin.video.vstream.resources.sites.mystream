...
SITE_IDENTIFIER = 'mystream_zone2'
SITE_NAME = 'My Stream 2'
...
def load():
    ...
    oGui.addDir(SITE_IDENTIFIER, SERIE_TOP_IMD[1], 'Serie (Top IMDd)', 'tmdb.png', oOutputParameterHandler)
